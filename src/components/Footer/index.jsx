      ...
      <div className="group-div">
        <div className="group-div">
          <div className="nauber-pro-div">
            ...
            <img className="phone-icon" alt="" src="src\assets\image\phone.svg" />
            ...
            <img
              ...
              alt=""
              src="src\assets\image\redes-sociais-icon.svg"
            />
            ...
            <img className="pin-icon" alt="" src="src\assets\image\pin.svg" />
