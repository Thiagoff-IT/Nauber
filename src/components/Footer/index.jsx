        ...
        <div className="group-div">
          <div className="group-div">
            <div className="nauber-pro-div">
              ...
              <div className="siga-nas-redes-sociais">Siga nas redes sociais</div>
              ...
              <div className="redes-sociais-icon">
              ...
              <div className="dvidas-div">
                <div className="converse-com-um-especialista">Converse com um especialista</div>
              ...
              <div className="nossa-sede-div">
                <div className="rua-mal-castelo-branco-2477">
                  <p className="conhea-o-sistema-footer">Rua Mal. Castelo Branco, 2477 Centro</p>
                  <p className="revenda-p-footer">Schroeder - SC.</p>
                </div>
                <div className="div">+55 (47) 3374-5969</div>
                <div className="div1">+55 (47) 99621-0018</div>
