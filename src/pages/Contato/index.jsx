  ...
  return (
    <div className="contato-div2">
      ...
      <div className="headline-div1">
        ...
        <b className="contato-b3">{t('CONTATO')}</b>
      </div>
      ...
      <div className="contatos-rpidos-div">
        <a href="https://wa.me/5547996210018?text=Ol%C3%A1%2C+vim+do+site.+Pode+me+tirar+algumas+d%C3%BAvidas%3F">
          <div className="div18">(47) 99621-0018</div>
        </a>
        <div className="div19">(47) 3374-5969</div>
        <div className="contatonaubercombr-div">atendimento@nauber.com.br</div>
        <div className="segunda-a-sexta-730-1748">Segunda a Sexta: 7:30 - 17:48</div>
        ...
        <div className="icones-redes">
          <a href="https://www.facebook.com/naubermaquinas">
            <Icon icon="ic:baseline-facebook" className="ItemSocial" color="#0fa958" />
          </a>
          <a href="https://www.instagram.com/naubermaquinas/">
            <Icon icon="mdi:instagram" className="ItemSocial" color="#0fa958" />
          </a>
          <a href="https://www.youtube.com/@naubermaquinas2080">
            <Icon icon="mdi:youtube" className="ItemSocial" color="#0fa958" />
          </a>
          <a href="">
            <Icon icon="mdi:pinterest" className="ItemSocial" color="#0fa958" />
          </a>
          <a href="https://www.tiktok.com/@naubermaquinas">
            <Icon icon="ic:baseline-tiktok" className="ItemSocial" color="#0fa958" />
          </a>
        </div>
        ...
        <img className="icround-access-time-filled-icon" alt="" src={Icround} />
      </div>
      ...
      <div className="form-div2">
        ...
        <input
          type="text"
          className="telefone-para-contato"
          placeholder={t('Telefone para contato')}
        />
        <input
          type="text"
          className="escreva-sua-mensagem-aqui"
          placeholder={t('Escreva sua mensagem aqui...')}
        />
        <a href="#" class="enviar-b">
          {t('enviar')}
        </a>
      </div>
      ...
      <div className="footer-div4">
        <div className="footer-div5">
          ...
          <div className="dvidas-div2">
            <div className="converse-com-um-especialista2">Converse com um especialista</div>
            <div className="envie-um-e-mail2">Envie um e-mail</div>
            <Link to="/" className="voltar-ao-incio2">
              Voltar ao início
            </Link>
            <div className="ficou-com-dvidas2">Ficou com dúvidas?</div>
          </div>
          <div className="produtos-div7">
            <Link to="/" className="construo-civil-div2">
              Construção civil
            </Link>
            <Link to="/" className="linha-industrial-div2">
              Linha industrial
            </Link>
          ...
          <div className="nossa-sede-div4">
            <div className="rua-mal-castelo-branco-24772">
              <p className="rua-mal-castelo2">Rua Mal. Castelo Branco, 2477 Centro</p>
              <p className="schroeder-sc2">Schroeder - SC.</p>
            </div>
            <div className="div15">+55 (47) 3374-5969</div>
            <div className="div16">+55 (47) 99621-0018</div>

            <div className="nossa-sede-div5">Nossa sede</div>
          </div>

          <div className="line-div5" />
          <img className="logo-nauber-icon2" alt="" src={Nauber} />
