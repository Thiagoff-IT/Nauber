    ...
    <div className="sobre-a-nauber2">
      <div className="footer-div20">
        <div className="footer-div21">
          ...
          <img className="phone-icon32" alt="" src="src\assets\image\phone32.svg" />
          ...
          <img className="pin-icon11" alt="" src="src\assets\image\pin11.svg" />
      ...
      <div className="frame-div6">
        <div className="footer-div21">
          <img className="bg-icon3" alt="" src="src\assets\image\bg@2x.png" />
          <img className="nauber-pro-11" alt="" src="src\assets\image\nauber-pro-1@2x.png" />
      ...
      <div className="video-div6">
        ...
        <img className="play-icon6" alt="" src="src\assets\image\play6.svg" />
      </div>
      <div className="group-div25">
        <img
          className="flag-brasil-2-icon19"
          alt=""
          src="src\assets\image\flagbrasil-219@2x.png"
        />
