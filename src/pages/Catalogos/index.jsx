    ...
    <div className="catlogos-div3">
      <div className="footer-div6">
        <div className="footer-div7">
          ...
          <img className="phone-icon13" alt="" src="src\assets\image\phone13.svg" />
          ...
          <img className="pin-icon4" alt="" src="src\assets\image\pin4.svg" />
        ...
        <div className="linha-varejo-div1">
          ...
          <div className="bandeiras-div">
            <img
              ...
              alt=""
              src="src\assets\image\flagbrasil-2@2x.png"
            />
            <img
              className="flag-espanha-2-icon"
              alt=""
              src="src\assets\image\flagespanha-2@2x.png"
            />
            <img className="flag-eua-2-icon" alt="" src="src\assets\image\flageua-2@2x.png" />
          </div>
        </div>
