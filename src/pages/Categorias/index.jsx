            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="projetoras-de-textura2">
                  ...
                  <div className="equipamentos-airless-div">{t('equipamentos airless')}</div>
                </div>
              </Link>
            </div>
            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="projetoras-de-textura">
                  ...
                  <div className="projetoras-de-textura1">{t('projetoras de textura')}</div>
                </div>
              </Link>
            </div>
            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="projetoras-de-textura3">
                  <img className="vector-icon71" alt="" src={Vetor1} />
                  <div className="demarcao-viria-div">{t('demarcação viária')}</div>
                </div>
              </Link>
            </div>
          </div>
            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="compressor-div3">
                  ...
                  <div className="desempenadeiras-div">{t('desempenadeiras')}</div>
                </div>
              </Link>
            </div>
          </div>
            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="bicos-airless-div">
                  ...
                  <div className="pistolas-airless-div">{t('pistolas airless')}</div>
                </div>
              </Link>
            </div>
            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="bicos-airless-div3">
                  ...
                  <div className="filmes-de-mascaramento">{t('filmes de mascaramento')}</div>
                </div>
              </Link>
            </div>
          </div>
            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="Pecas">
                  ...
                  <div className="Pecas-div">{t('Peças')}</div>
                </div>
              </Link>
            </div>
            ...
            <div className="projetorasDeTextura">
              <Link to="/Produtos">
                ...
                <div className="acessorios">
                  ...
                  <div className="acessorios-div">{t('acessórios')}</div>
                </div>
              </Link>
            </div>
          </div>
