...
const ProdutoDetalhes1 = () => {
  return (
    <div className="produto-detalhes1">
      <div className="footer-div18">
        <div className="footer-div19">
          <div className="bg-div10" />
          <img className="phone-icon31" alt="" src="src\assets\image\phone31.svg" />
          <div className="siga-nas-redes-sociais9">Siga nas redes sociais</div>
          <div className="nauber-2022-todos-os-direito9">
            Nauber © 2022 Todos os direitos reservados.
          </div>
          <div className="politicas-de-privacidade-ter9">
            Politicas de Privacidade | Termos de Uso
          </div>
          <div className="nauber-maquinas-e-equipamentos9">
            20.633.257/0001-98 | NAUBER MAQUINAS E EQUIPAMENTOS
          </div>
          <img
            className="redes-sociais-icon9"
            alt=""
            src="src\assets\image\redes-sociais-icon7.svg"
          />
          <div className="dvidas-div9">
            <div className="converse-com-um-especialista9">
              Converse com um especialista
            </div>
            <div className="envie-um-e-mail9">Envie um e-mail</div>
            <div className="voltar-ao-incio9">Voltar ao início</div>
            <div className="ficou-com-dvidas9">Ficou com dúvidas?</div>
          </div>
          <div className="produtos-div28">
            <div className="construo-civil-div9">Construção civil</div>
            <div className="linha-industrial-div10">Linha industrial</div>
            <div className="ficou-com-dvidas9">Produtos</div>
          </div>
          <div className="nossa-sede-div18">
            <div className="rua-mal-castelo-branco-247710">
              <p className="rua-mal-castelo9">
                Rua Mal. Castelo Branco, 2477 Centro
              </p>
              <p className="schroeder-sc9">Schroeder - SC.</p>
            </div>
            <div className="div50">+55 (47) 3374-5969</div>
            <div className="div51">+55 (11) 96364-6599</div>
            <div className="div52">+55 (47) 98821-2725</div>
            <div className="nossa-sede-div19">Nossa sede</div>
          </div>
          <img className="pin-icon10" alt="" src="src\assets\image\pin8.svg" />
          <div className="line-div24" />
          <img
            className="logo-nauber-icon9"
            alt=""
      ...
      <div className="header-div9">
        <div className="bg-header28" />
        <div className="bg-header29" />
        <div className="bg-header30" />
        <div className="logo-div9">
          <img
            className="nauber-logo-1-icon9"
            alt=""
            src="src\assets\image\nauberlogo-1@2x.png"
          />
          <img
            className="logo-nauber-19"
            alt=""
            src="src\assets\image\logo-nauber-1@2x.png"
          />
        </div>
        <div className="menu-div9">
          <img className="vector-icon54" alt="" src="src\assets\image\vector-83.svg" />
          <div className="home-div10">
            <b className="home-b9">HOME</b>
            <img className="home-icon9" alt="" src="src\assets\image\home9.svg" />
          </div>
          <div className="empresa-div9">
            <img className="empresa-icon9" alt="" src="src\assets\image\empresa.svg" />
            <b className="empresa-b9">EMPRESA</b>
          </div>
          <div className="produtos-div30">
            <b className="produtos-b9">PRODUTOS</b>
            <img className="box-icon9" alt="" src="src\assets\image\box9.svg" />
          </div>
          <div className="assistencia-div9">
            <b className="assistncias-b10">ASSISTÊNCIAS</b>
            <img className="home-icon9" alt="" src="src\assets\image\assistencias5.svg" />
          </div>
          <div className="catlogos-div11">
            <b className="catlogos-virtuais-b10">CATÁLOGOS VIRTUAIS</b>
            <img className="home-icon9" alt="" src="src\assets\image\catalagos5.svg" />
          </div>
          <div className="contato-div10">
            <b className="contato-b10">CONTATO</b>
            <img className="home-icon9" alt="" src="src\assets\image\contato5.svg" />
          </div>
          <div className="login-div9">
            <b className="login-b9">login</b>
            <img className="logim-icon9" alt="" src="src\assets\image\logim.svg" />
          </div>
        </div>
        <div className="flags-div9">
          <img className="vector-icon55" alt="" />
          <img
            className="flag-brasil-1-icon9"
            alt=""
            src="src\assets\image\flagbrasil-19@2x.png"
          />
          <img
            className="flag-espanha-1-icon9"
            alt=""
            src="src\assets\image\flagespanha-1@2x.png"
          />
          <img className="flag-eua-1-icon9" alt="" src="src\assets\image\flageua-1@2x.png" />
          <img
            className="flag-arabia-1-icon9"
            alt=""
            src="src\assets\image\flagarabia-11@2x.png"
          />
        </div>
        <div className="line-div25" />
        <img
          className="base-de-conhecimento-19"
          alt=""
          src="src\assets\image\base-de-conhecimento-1@2x.png"
        />
        <img
          className="logo-revenda-pro-19"
          alt=""
          src="src\assets\image\logo-revenda-pro-1@2x.png"
        />
        <div className="conhea-o-sistema-de-revnda-n9">
          <p className="rua-mal-castelo9">
            <span className="conhea-o-sistema19">
          ...
          <p className="nauber-pro10">
            <span>
              <b>NAUBER PRO</b>
            </span>
          </p>
        </div>
        <div className="seach-div9">
          <div className="rectangle-div238" />
          <img className="frame-icon8" alt="" src="src\assets\image\frame-24.svg" />
        </div>
      </div>
      <img className="vector-icon56" alt="" src="src\assets\image\vector-1185.svg" />
      ...
      <div className="group-div23">
        ...
        <img className="seta-icon46" alt="" src="src\assets\image\seta9.svg" />
      </div>
      <div className="linha-1-div6">
        <div className="produto-div5">
          <div className="rectangle-div239" />
          <div className="rectangle-div240" />
          <img className="icon26" alt="" src="src\assets\image\01-13@2x.png" />
      ...
      <div className="video-div5">
        ...
        <b className="apresentao-tcnica-turbina5">
          <p className="rua-mal-castelo9">Apresentação Técnica - Turbina</p>
      ...
      <div className="card-endereo-div6">
        ...
        <div className="virificar-endereo-div3">
          ...
          <div className="informe-seu-cep3">Informe seu CEP</div>
        ...
        <img className="seach-icon6" alt="" src="src\assets\image\seach2.svg" />
        <img className="seach-icon7" alt="" src="src\assets\image\seach2.svg" />
      </div>
      <div className="linha-4-div3">
        <div className="produto-1-div6">
          ...
          <div className="boto-div26">
            ...
            <img className="seta-icon47" alt="" src="src\assets\image\seta37.svg" />
          </div>
          <div className="rectangle-div255" />
          <img className="icon27" alt="" src="src\assets\image\01-2@2x.png" />
        </div>
        <div className="produto-2-div6">
          ...
          <div className="boto-div26">
            <div className="rectangle-div254" />
            <div className="saiba-mais-div24">SAIBA MAIS</div>
            <img className="seta-icon47" alt="" src="src\assets\image\seta28.svg" />
          </div>
          <div className="rectangle-div255" />
          <img className="icon27" alt="" src="src\assets\image\01-21@2x.png" />
        </div>
        <div className="produto-3-div6">
          ...
          <div className="boto-div26">
            <div className="rectangle-div254" />
            <div className="saiba-mais-div24">SAIBA MAIS</div>
            <img className="seta-icon47" alt="" src="src\assets\image\seta29.svg" />
          </div>
          <div className="rectangle-div255" />
          <img className="icon27" alt="" src="src\assets\image\01-26@2x.png" />
        </div>
        <div className="produto-4-div6">
          ...
          <div className="boto-div26">
            <div className="rectangle-div254" />
            <div className="saiba-mais-div24">SAIBA MAIS</div>
            <img className="seta-icon47" alt="" src="src\assets\image\seta50.svg" />
          </div>
          <div className="rectangle-div255" />
          <img className="icon27" alt="" src="src\assets\image\01-23@2x.png" />
        </div>
      </div>
      <div className="tpico-lanamento-div6">
        ...
        <img className="line-icon6" alt="" src="src\assets\image\line-3.svg" />
...
export default ProdutoDetalhes1;
