...
function ProdutoLogistas1(){
  return (
    <div className="produto-logistas1">
      <div className="footer-div10">
        <div className="footer-div11">
          <div className="bg-div6" />
          <img className="phone-icon21" alt="" src="src\assets\image\phone21.svg" />
          <div className="siga-nas-redes-sociais5">Siga nas redes sociais</div>
          <div className="nauber-2022-todos-os-direito5">
            Nauber © 2022 Todos os direitos reservados.
          </div>
          <div className="politicas-de-privacidade-ter5">
            Politicas de Privacidade | Termos de Uso
          </div>
          <div className="nauber-maquinas-e-equipamentos5">
            20.633.257/0001-98 | NAUBER MAQUINAS E EQUIPAMENTOS
          </div>
          <img
            className="redes-sociais-icon5"
            alt=""
            src="src\assets\image\redes-sociais-icon5.svg"
          />
          <div className="dvidas-div5">
            <div className="converse-com-um-especialista5">
              Converse com um especialista
            </div>
            <div className="envie-um-e-mail5">Envie um e-mail</div>
            <div className="voltar-ao-incio5">Voltar ao início</div>
            <div className="ficou-com-dvidas5">Ficou com dúvidas?</div>
          </div>
          <div className="produtos-div16">
            <div className="construo-civil-div5">Construção civil</div>
            <div className="linha-industrial-div6">Linha industrial</div>
            <div className="ficou-com-dvidas5">Produtos</div>
          </div>
          <div className="nossa-sede-div10">
            <div className="rua-mal-castelo-branco-24776">
              <p className="rua-mal-castelo5">
                Rua Mal. Castelo Branco, 2477 Centro
              </p>
              <p className="schroeder-sc5">Schroeder - SC.</p>
            </div>
            <div className="div32">+55 (47) 3374-5969</div>
            <div className="div33">+55 (11) 96364-6599</div>
            <div className="div34">+55 (47) 98821-2725</div>
            <div className="nossa-sede-div11">Nossa sede</div>
          </div>
          <img className="pin-icon6" alt="" src="src\assets\image\pin6.svg" />
</div>
</div>
<Header />
...
export default ProdutoLogistas1;
